# medigo-extractors-v2 worker-2 (batch 1)

你的工作目录: `/home/sophomores/code/medigo-w2` (git branch `work/v2-batch1-w2`).
任务清单: med66, smartedu, htknow
...
源码目录: `~/code/xwz-downloader-source-release/decompiled_full/Mooc/Courses/Med66/`
Go 目标文件: `internal/extractor/med66/med66.go`
...
### 2. smartedu (single-api)

源码目录: `~/code/xwz-downloader-source-release/decompiled_full/Mooc/Courses/Smartedu/`
Go 目标文件: `internal/extractor/smartedu/smartedu.go`
当前状态: STUB (verify_full_alignment.py 报)
...
源码目录: `~/code/xwz-downloader-source-release/decompiled_full/Mooc/Courses/Htknow/`
Go 目标文件: `internal/extractor/htknow/htknow.go`
当前状态: STUB (verify_full_alignment.py 报)
...
# 然后报告: "worker-2 done, N/M sites PASS, branch pushed"
```
