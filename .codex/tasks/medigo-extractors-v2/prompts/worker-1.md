# medigo-extractors-v2 worker-1 (batch 1)

你的工作目录: `/home/sophomores/code/medigo-w1` (git branch `work/v2-batch1-w1`).
任务清单: jianshe99, ahu, cctalk
...
### 1. jianshe99 (csslcloud)

源码目录: `~/code/xwz-downloader-source-release/decompiled_full/Mooc/Courses/Jianshe99/`
Go 目标文件: `internal/extractor/jianshe99/jianshe99.go`
...
源码目录: `~/code/xwz-downloader-source-release/decompiled_full/Mooc/Courses/Ahu/`
Go 目标文件: `internal/extractor/ahu/ahu.go`
当前状态: STUB (verify_full_alignment.py 报)
...
源码目录: `~/code/xwz-downloader-source-release/decompiled_full/Mooc/Courses/cctalk/`
Go 目标文件: `internal/extractor/cctalk/cctalk.go`
当前状态: STUB (verify_full_alignment.py 报)
...
# 然后报告: "worker-1 done, N/M sites PASS, branch pushed"
```
